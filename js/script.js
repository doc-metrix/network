...
(function() {
	...
	URLs.readme = 'https://api.github.com/repos/doc-metrix/network/contents/README.md';
	URLs.markdown = 'https://api.github.com/markdown';
	URLs.doc = 'https://api.github.com/repos/doc-metrix/network/contents/doc/index.json';

	CONTEXT = 'doc-metrix/network';
	...
	*/
	...
	/**
	* FUNCTION: onDoc( blob )
	*	Handler for receiving a metric resource.
	*
	* @private
	* @param {String} blob - content blob which will be parsed as JSON
	*/
